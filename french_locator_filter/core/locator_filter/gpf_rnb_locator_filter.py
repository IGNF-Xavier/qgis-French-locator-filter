...
class GpfRnbGeocoderLocatorFilter(RestAPILocatorFilter):
    """QGIS Locator Filter subclass using the RNB (Référentiel National du Bâti) API"""
    ...
    def clone(self) -> QgsLocatorFilter:
        ...
        """
        return GpfRnbGeocoderLocatorFilter(self._canvas)
    ...
    def displayName(self) -> str:
        ...
        :rtype: str
        """
        return self.tr("RNB (bâtiment) geocoder")
