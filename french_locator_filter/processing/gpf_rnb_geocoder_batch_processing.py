...
class GpfRnbGeocoderBatchProcessing(QgsBatchGeocodeAlgorithm):
    def __init__(self):
        super().__init__(geocoder)

    def displayName(self):
        return self.tr("Batch RNB (bâtiment) geocoding")
    ...
    def createInstance(self):
        return GpfRnbGeocoderBatchProcessing()
    ...
    def tags(self):
        return ["geocode", "rnb", "bâtiment", "batch"]
