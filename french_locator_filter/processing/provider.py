...
# project
from french_locator_filter.__about__ import __icon_path__, __title__, __version__
...
class FrenchLocatorProcessingProvider(QgsProcessingProvider):
    """
