...
- docstrings: [sphinx-style](https://sphinx-rtd-tutorial.readthedocs.io/en/latest/docstrings.html#the-sphinx-docstring-format) is used to write technical documentation. Please use type hints and annotations to make the code fully compatible with related mechanisms (Sphinx, IDE...).
